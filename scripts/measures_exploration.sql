...
UNION ALL
SELECT 'Total Orders', COUNT(DISTINCT order_number) total_orders FROM gold.fact_sales
UNION ALL
SELECT 'Total Products', COUNT(DISTINCT  product_name) AS total_products FROM gold.dim_products
UNION ALL
SELECT 'Total Customers', COUNT(customer_key) total_customers FROM gold.dim_customers
